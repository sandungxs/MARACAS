...
Click here to download a compressed example folder generated by MARACAS for an RNA-seq analysis.
Click here to download a compressed example folder generated by MARACAS for a ChIP-seq analysis.

The MARACAS output folder for an RNA-seq  
